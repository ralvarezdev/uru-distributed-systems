...
public class TicTacToeService : TicTacToe.TicTacToeBase
{
        ...
        ServerCallContext context)
    {
        ...
        while (!context.CancellationToken.IsCancellationRequested)
        {
            ...
            var reply = new WaitForPlayerReply
            {
                ...
                Status = gameStatus,
                InviteeName = game.InviteePlayer?.Name
            };
        ...
        ServerCallContext context)
    {
        ...
        return Task.FromResult(new JoinGameReply
            { GameId = game.GameId, Symbol = inviteePlayerSymbol, HostName = game.HostPlayer.Name });
    }
    ...
    private class Board
    {
        private List<Row> Rows { get; } = [new(), new(), new()];
    ...
    private class Row
    {
        private List<Cell> Cells { get; } = [Cell.Empty, Cell.Empty, Cell.Empty];
